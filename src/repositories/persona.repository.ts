...
> {
  ...
  constructor(
    @inject('datasources.mongodbatlas') dataSource: MongodbatlasDataSource, @repository.getter('PedidoRepository') protected pedidoRepositoryGetter: Getter<PedidoRepository>,
  ) {
